...
sweep_id = "sweep-3ij1dil0"
run_id = "9n7hr33y" #"4iash5zq" # "lehm2tdm"# "rxqa77ge" #"y2zpx2zx"  #"uaac940v"
...
def main():
    ...
    f = dir+sweep_id+"/config-"+run_id+".yaml"
    print(f)
    ...
    print(details)
    np.vstack(details)
    np.savetxt("eval_details_sweep_" +sweep_id+"_run_" + run_id + ".csv", np.vstack(details), fmt="%s", delimiter=',')
